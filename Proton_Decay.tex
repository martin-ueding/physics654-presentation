...
\begin{frame}
    Particles are basis vectors of irreps (irreducible representations).

    Irreps used in the SM:
    \begin{itemize}
        \item $d = 3$ for color (quarks)
        \item $d = 2$ for weak isospin (doublets)
        \item $d = 1$ abelian irrep for hypercharge
        \item Trivial irrep
    \end{itemize}
\end{frame}
